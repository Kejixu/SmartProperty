...
function bitcoinsig_test(pk, message) {
    /*
    ...
    */
    var private_key = pk;
    var address_assoc_with_privKey = '16P4ScrQVD9xrgVHPhKUGJo2GjdJjfEKqV';
    //nonce that I send you guys
    var nonce = message;
    //random stuff ignore it
    payload = Bitcoin.Base58.decode(private_key);
    console.log('payload:' + payload);
    secret = payload.slice(1, payload.length - 4);
    compressed = payload.length == 38;
    console.log('compressed: ' + compressed);
    //actual signing
    sig = sign_message(new Bitcoin.ECKey(secret), nonce, compressed);
    //return back this signature
    console.log(sig);
}
